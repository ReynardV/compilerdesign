...
class variable_scope {
 public:
  ...
  ~variable_scope() = default;
  const //stack of tuples; var_name and var_type
}
...
class ASTNode {
 public:
  ...
  virtual std::string check_type() const = 0;
...
class AbsASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){
      if (child_->check_type()=="string") {return "string";} else {return "WRONG";}  
  }
...
class UnaryASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){
      if (child_->check_type()=="int") {return "int";} else {return "WRONG";}  
  }
...
class BinaryASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){
      if (left_->check_type()=="int" and right_->check_type()=="int") {return "int";} else {return "WRONG";}  
  }
...
class NoEvalBinaryASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){ //!!!!!!!!Not Right!!!!!!!!!
      if (left_->check_type()=="int" and right_->check_type()=="int") {return "int";} else {return "WRONG";}  
  }
...
class TertiaryASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){
      if (left_->check_type()=="bool" and middle_->check_type()==right_->check_type()) {return middle_->check_type();} else {return "WRONG";}  
  }
...
class QuaternaryASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){ //!!!!!!!!!!!!WRONG!!!!!!!!!!!!!!!
      return one_->check_type();
  }
...
class VectorASTNode : public ASTNode {
 public:
  ...
  virtual std::string check_type(){ //just checks contents are consistent right now
      if (first_->check_type()==last_->check_type()) {return first_->check_type();} else {return "WRONG";}  
  }
